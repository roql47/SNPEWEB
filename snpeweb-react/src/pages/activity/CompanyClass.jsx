  ...
  return (
    <>
      <PageBanner
        ...
        breadcrumb={[{ label: t('nav.education'), path: '/degree' }, { label: t('pages.companyClass') }]}
      />
      ...
      <section className="py-16 md:py-24">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="bg-snpe/5 rounded-3xl p-8 md:p-12 text-center">
            ...
            <a href="tel:02-539-2925" className="inline-block px-8 py-3 bg-snpe-darker text-white rounded-full font-medium hover:bg-snpe-dark transition-colors">
              ☎ 02-539-2925
            </a>
          </div>
        </div>
