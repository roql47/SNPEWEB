  ...
  return (
    <section className="relative w-full h-screen min-h-[720px] overflow-hidden">
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center px-6 text-center">
        <h1 className="text-white font-heading font-bold tracking-tight text-4xl sm:text-5xl md:text-6xl lg:text-7xl leading-[1.15] drop-shadow-lg">
          Self Natural Posture Exercise
        </h1>
